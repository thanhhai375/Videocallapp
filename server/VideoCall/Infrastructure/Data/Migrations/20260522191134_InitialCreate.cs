...
namespace VideoCall.Infrastructure.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MessageReadReceipts_Users_ReaderId",
                        column: x => x.ReaderId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageReactions_MessageId_UserId_EmojiCode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageReadReceipts_MessageId_ReaderId",
                table: "MessageReadReceipts",
                columns: new[] { "MessageId", "ReaderId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MessageReadReceipts_ReaderId",
                table: "MessageReadReceipts",
                column: "ReaderId");

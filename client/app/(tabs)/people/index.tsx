...
const styles = StyleSheet.create({
  ...
  headerTitle:      { fontSize: 26, fontWeight: '800', color: '#F0F0FF', letterSpacing: -0.5 },
  headerSub:        { fontSize: 12, color: Colors.textMuted, marginTop: 2 },
  headerActions:    { flexDirection: 'row', gap: 8 },
  headerBtn:        { width: 38, height: 38, borderRadius: 19, backgroundColor: '#1A1A2E', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#2A2A3E' },
  ...
  // Search bar
  searchBarInner: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#13131F', borderRadius: 12, borderWidth: 1, borderColor: `${NEON}40`, marginBottom: 8 },
  searchInput:    { flex: 1, paddingHorizontal: 10, paddingVertical: 12, color: '#F0F0FF', fontSize: 14 },

  // Tabs
  tabWrap:      { paddingHorizontal: 16, marginBottom: 4 },
  tabBar:       { flexDirection: 'row', backgroundColor: '#13131F', borderRadius: 14, height: 42, position: 'relative', borderWidth: 1, borderColor: '#2A2A3E' },
  ...
  // Radar
  radarPanel:     { alignItems: 'center', paddingVertical: 12, paddingBottom: 8, borderBottomWidth: 1, borderBottomColor: '#1A1A2E', marginHorizontal: 16, marginBottom: 8 },
  ...
  selfAvatar:     { width: 52, height: 52, borderRadius: 26, backgroundColor: NEON, justifyContent: 'center', alignItems: 'center', borderWidth: 2.5, borderColor: '#fff', zIndex: 10 },
  selfAvatarText: { color: '#fff', fontSize: 20, fontWeight: '800' },
  selfPingDot:    { position: 'absolute', width: 10, height: 10, borderRadius: 5, backgroundColor: ONLINE, bottom: -30, right: -30, borderWidth: 2, borderColor: '#0A0A0F', zIndex: 11 },
  ...
  onlineDot:      { position: 'absolute', width: 10, height: 10, borderRadius: 5, backgroundColor: ONLINE, bottom: -1, right: -1, borderWidth: 1.5, borderColor: '#0A0A0F' },
  radarNameTag:   { position: 'absolute', top: 42, alignSelf: 'center', backgroundColor: 'rgba(10,10,15,0.85)', borderRadius: 6, paddingHorizontal: 5, paddingVertical: 2, minWidth: 40, alignItems: 'center' },
  radarNameText:  { color: '#E0E0FF', fontSize: 9, fontWeight: '600', maxWidth: 60 },
  ...
  // Friend card
  friendCard:      { flexDirection: 'row', alignItems: 'center', backgroundColor: '#13131F', borderRadius: 16, marginBottom: 8, paddingVertical: 12, paddingRight: 12, borderWidth: 1, borderColor: '#1E1E30', overflow: 'hidden' },
  ...
  cardOnlineBadge: { position: 'absolute', width: 12, height: 12, borderRadius: 6, backgroundColor: ONLINE, bottom: 0, right: 0, borderWidth: 2, borderColor: '#13131F' },
  cardInfo:        { flex: 1, marginLeft: 10 },
  cardName:        { color: '#F0F0FF', fontSize: 15, fontWeight: '700' },
  ...
  // Pending card
  pendingCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#13131F', borderRadius: 16, marginBottom: 8, padding: 12, borderWidth: 1, borderColor: '#1E1E30' },
  ...
  emptyTitle: { fontSize: 19, fontWeight: '700', color: '#F0F0FF', marginBottom: 8 },
  ...
  // Modal
  modalBg:       { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.72)' },
  modalSheet:    { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: '#0F0F1A', borderTopLeftRadius: 28, borderTopRightRadius: 28, paddingHorizontal: 20, paddingBottom: Platform.OS === 'ios' ? 40 : 28, paddingTop: 12, borderTopWidth: 1, borderColor: '#2A2A40' },
  ...
  modalCloseBtn: { width: 30, height: 30, borderRadius: 15, backgroundColor: '#1A1A2E', justifyContent: 'center', alignItems: 'center' },
  inputWrap:     { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1A1A28', borderRadius: 14, borderWidth: 1.5, borderColor: '#2A2A40', overflow: 'hidden', marginBottom: 8 },
  inputWrapErr:  { borderColor: Colors.danger },
  flagChip:      { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 12, paddingVertical: 13, borderRightWidth: 1, borderRightColor: '#2A2A40' },
  flagCode:      { color: Colors.textSecondary, fontSize: 13, fontWeight: '600' },
  phoneInput:    { flex: 1, paddingHorizontal: 12, paddingVertical: 13, color: '#F0F0FF', fontSize: 16, fontWeight: '500' },
  ...
  shimmerAvatar: { width: 46, height: 46, borderRadius: 23, backgroundColor: '#1A1A28' },
  shimmerBar:    { height: 12, borderRadius: 6, backgroundColor: '#1A1A28' },
  resultCard:    { backgroundColor: '#13131F', borderRadius: 16, borderWidth: 1.5, padding: 14, marginTop: 4 },
  ...
  resultName:    { color: '#F0F0FF', fontSize: 15, fontWeight: '700' },
